...
##### Новое!
  ...
  - Добавлена возможность смены отображения клавиш на keystrokes'е
  - Новый реденринг предметов
  - Фикс бага при рендеринге самих предметов
  - Новый keystrokes
...
| /keystrokes space | Вкл/Выкл отображения пробела |
| /keystrokes mouse | Вкл/Выкл отображения кнопок мыши |
---
