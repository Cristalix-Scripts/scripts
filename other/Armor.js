(function (self) {
    ...
    function drawArmor(slot, x, y) {
	    ...
	    RenderHelper.enableGUIStandardItemLighting();
            let item = InventoryDeprecated.getStackInSlot(slot)
            let amount = InventoryDeprecated.getCount(slot)
            let damage = InventoryDeprecated.getDurability(slot)
            var maxDamage = InventoryDeprecated.getMaxDamage(slot)
